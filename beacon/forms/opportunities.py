...
class CategoryForm(Form):
    ...
    See Also:
        * :py:func:`~purchasing.beacon.blueprints.opportunity_view_util.select_multi_checkbox`
    ...
    Attributes:
        subcategories: A :py:class:`~purchasing.forms.front.MultiCheckboxField`
        categories: A :py:class:`~purchasing.forms.front.DynamicSelectField`
    '''
    ...
    def build_categories(self, all_categories):
        ...
        For our :py:func:`~purchasing.beacon.blueprints.opportunity_view_util.select_multi_checkbox`, we need to give
        ...
        Arguments:
            all_categories: A list of :py:class:`~purchasing.models.front.Category` objects
...
class OpportunitySignupForm(Form):
    ...
    def post_validate_action(self, opportunity):
        ...
        if signup_success:
            flash(Markup("Successfully subscribed for updates! <a href='/signup'>Sign up</a> for alerts about future opportunities."), 'alert-success')
...
class OpportunityDocumentForm(NoCSRFForm):
    '''Document subform for the main :py:class:`~purchasing.forms.front.OpportunityForm`
    ...
    def upload_document(self, _id):
        ...
        Arguments:
            _id: The id of the :py:class:`~purchasing.models.front.Opportunity`
...
class OpportunityForm(CategoryForm):
    ...
    def display_cleanup(self, opportunity=None):
        ...
        Arguments:
            opportunity: A :py:class:`purchasing.front.model.Opportunity` object
                or None.
        '''
    ...
    def data_cleanup(self):
        ...
        Returns:
            ...
            instantiate or modify an :py:class:`~purchasing.front.model.Opportunity`
            instance
        '''
